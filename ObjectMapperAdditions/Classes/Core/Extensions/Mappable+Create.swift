...
public extension Mappable {
    ...
    static func safeCreate(jsonData: Data?) -> Self? {
        do {
            ...
            RoutableLogger.logError("Unable to create object from JSON data", error: error, data: ["jsonData": jsonData, "self": self])
            return nil
        }
    }
}
...
public extension Mappable {
    ...
    static func safeCreate(jsonString: String?) -> Self? {
        do {
            ...
            RoutableLogger.logError("Unable to create object from JSON string", error: error, data: ["jsonString": jsonString, "self": self])
            return nil
        }
    }
}
